...
class Picarx(object):
    ...
    def set_motor_speed(self,motor,speed):
        try:
            ...
            print("Setting motor {0} with speed:{1}".format(motor,speed))
            pass
    ...
    def motor_speed_calibration(self,value):
        try:
            ...
            print("Calibrating motor speed :{0}".format(value))
            pass
    ...
    def motor_direction_calibration(self,motor, value):
        try:
            ...
            print("Calibrating motor {0} direction :{1}".format(motor,value))
            pass
    ...
    def dir_servo_angle_calibration(self,value):
        try:
            ...
            print("Calibrating servo at angle:{0}".format(value))
            pass
    ...
    def set_dir_servo_angle(self,value):
        try:
            ...
            print("Setting servo at angle:{0}".format(value))
            pass 
    ...
    def set_power(self,speed):
        try:
            ...
            print("Set power of motors:{0}".format(speed)) 
            pass
    ...
    def backward(self,speed):
        try:
            ...
            print("Moving backward with speed:{0}".format(speed))
            pass 
